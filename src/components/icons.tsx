...
export function Truck({ className = "", size = 24 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function Factory({ className = "", size = 24 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function Briefcase({ className = "", size = 24 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function Quote({ className = "", size = 24 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
